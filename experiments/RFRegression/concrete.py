...
def execute(save_dir, n_buckets=3, i=None, bucketing_method="quantile", single_rules_breaks=3):
    # Load dataframe
    dataset_path = os.path.join(PROJECT_ROOT, "experiments/datasets/concrete_data.csv")
...
if __name__ == '__main__':
    save_dir = os.path.join(PROJECT_ROOT, "examples/results/concrete")
    run_multiple_executions(save_dir, num_buckets=10, num_iterations=25)
