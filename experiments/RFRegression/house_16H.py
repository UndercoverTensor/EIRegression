...
def execute(save_dir, n_buckets=3, i=None, bucketing_method="quantile", single_rules_breaks=3):
    """
    Executes a single Random Forest regression experiment with the house_16H dataset.
    """

    # Load dataset dynamically
    dataset_path = os.path.join(PROJECT_ROOT, "experiments/datasets/house_16H.csv")
...
if __name__ == '__main__':
    dataset_name = "house_16H_3_breaks"
    
    save_dir = os.path.join(PROJECT_ROOT, "experiments/RFRegression/results/", dataset_name)
